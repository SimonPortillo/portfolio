...
import LinkIframePreview from '@/components/LinkIframePreview';
    ...
    >
      ...
      <div className="flex flex-wrap gap-2 sm:gap-3">
        {courses.map(course => {
          ...
          return href ? (
            <LinkIframePreview key={course.name} href={course.link!} className="focus:outline-none focus:ring-primary rounded group">
              <Badge
                variant="secondary"
